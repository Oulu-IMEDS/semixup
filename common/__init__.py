...
def init_args():
    ...
    parser.add_argument('--num_threads', type=int, default=8, help='Number of threads for data loader')
    ...
    parser.add_argument('--in_mnf_coef', type=float, default=2.0, help='In-manifold coef')
    parser.add_argument('--in_out_mnf_coef', type=float, default=2.0, help='In-out-manifold coef')
    parser.add_argument('--ic_coef', type=float, default=4.0, help='Interpolation consistency coef')
